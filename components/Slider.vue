...
<template>
    <div class="mt-20 w-full">
        ...
        <ul class="tag-list scroller__inner">
            <div class="card"><svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 256 351">
              <defs>
            ...
            <div class="card"><svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 256 135">
	<defs>
	...
	<path fill="#000004" d="M74.8 48.2c5.6 0 9.3 1 11.2 3.1s2.3 5.6 1.3 10.6c-1 5.2-3 9-5.9 11.2q-4.35 3.3-13.2 3.3h-8.9l5.5-28.2zM39 105h14.7l3.5-17.9h12.6c5.6 0 10.1-.6 13.7-1.8s6.8-3.1 9.8-5.9q3.75-3.45 6-7.5c1.5-2.7 2.6-5.7 3.2-9c1.6-8 .4-14.2-3.5-18.7s-10.1-6.7-18.6-6.7H52.1zm74.3-85.4h14.6l-3.5 17.9h13c8.2 0 13.8 1.4 16.9 4.3s4 7.5 2.8 13.9L151 87.1h-14.8l5.8-29.9c.7-3.4.4-5.7-.7-6.9s-3.6-1.9-7.3-1.9h-11.7l-7.5 38.7h-14.6zm76.2 28.6c5.6 0 9.3 1 11.2 3.1s2.3 5.6 1.3 10.6c-1 5.2-3 9-5.9 11.2q-4.35 3.3-13.2 3.3H174l5.5-28.2zM153.7 105h14.7l3.5-17.9h12.6c5.6 0 10.1-.6 13.7-1.8s6.8-3.1 9.8-5.9q3.75-3.45 6-7.5c1.5-2.7 2.6-5.7 3.2-9c1.6-8 .4-14.2-3.5-18.7s-10.1-6.7-18.6-6.7h-28.3z" />
            ...
            <div class="card"><svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 24 24">
	<path fill="currentColor" d="M12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2m4.37 3.7c1.02-.03 1.78.43 1.84 1.14c.01.31-.17.91-.79.93c-.47.02-.79-.27-.8-.68c-.01-.16.26-.67.26-.76c-.01-.27-.41-.28-.52-.27c-1.5.05-1.9 2.07-2.22 3.72l-.14.87c.84.13 1.46-.03 1.8-.25c.48-.31-.14-.63-.06-.99c.08-.37.41-.54.67-.55c.37-.01.63.37.62.76c-.03.64-.86 1.52-2.53 1.48c-.22 0-.41-.02-.59-.04c-.61 3.1-.99 4.94-2.35 6.52c-1.17 1.39-2.36 1.6-2.89 1.62c-1 .04-1.67-.49-1.67-1.2c-.03-.68.57-1.06.97-1.07c.53-.02.9.37.91.81c.02.37-.18.49-.31.56c-.07.07-.22.15-.21.3c0 .07.07.22.29.21c.42-.01.69-.22.89-.36c.96-.8 1.34-2.21 1.83-4.77c.26-1.45.45-2.38.73-3.3c-.68-.51-1.1-1.15-2.01-1.38c-.63-.19-1.01-.04-1.28.3c-.31.41-.21.93.09 1.24c1.15 1.28 1.49 1.84 1.36 2.6c-.2 1.21-1.64 2.13-3.34 1.61c-1.45-.45-1.72-1.47-1.55-2.04c.16-.49.55-.59.94-.47c.42.13.58.63.46 1.02c-.02.04-.22.41-.27.53c-.09.31.33.52.62.61c.65.2 1.28-.14 1.43-.67c.15-.48-.15-.82-.28-.95c-.89-.98-1.51-1.85-1.21-2.83c.12-.37.36-.77.72-1.04c.75-.55 1.57-.65 2.34-.41c1.01.27 1.49.94 2.12 1.45c.35-1.02.84-2.03 1.57-2.88c.66-.77 1.54-1.33 2.56-1.37" />
            ...
            <div class="card"><svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 256 339">
	<path fill="#fe8439" d="M208.493 111.5c-.294-.317-.562-.651-.872-.96L106.545 9.906C94.453-2.132 74.89-2.092 62.85 10s-11.997 31.655.095 43.694L96.348 86.95C40.966 101.042 0 151.233 0 211c0 70.693 57.308 128 128 128s128-57.308 128-128c0-40.189-18.535-76.032-47.507-99.5" />
	...
	<path fill="currentColor" d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2M8.4 15L8 13.77H6.06L5.62 15H4l2.2-6h1.62L10 15Zm8.36-3.5a1.47 1.47 0 0 1-1.5 1.5h-2v2h-1.5V9h3.5a1.47 1.47 0 0 1 1.5 1.5ZM20 15h-1.5V9H20Z" />
	<path fill="currentColor" d="M6.43 12.77h1.16l-.58-1.59z" />
</svg></div>
            <div class="card"><svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 256 221">
	...
	<path fill="#35495e" d="M50.56 0L128 133.12L204.8 0h-47.36L128 51.2L97.92 0z" />
            ...
            <div class="card"><svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 128 128">
	...
	<path fill="#ebebeb" d="M64.048 23.435v13.831H30.64l-.277-3.108l-.63-7.012l-.331-3.711zm-.047 27.996v13.831H48.792l-.277-3.108l-.631-7.012l-.33-3.711z" />
            ...
            <div class="card"><svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 256 256">
	<g fill="none" fill-rule="evenodd">
		<path fill="#e55638" d="M222.777 8.548a58.1 58.1 0 0 1 24.135 24.192c5.568 10.432 8.533 20.778 8.533 49.3v50.099a1.6 1.6 0 0 1-2.73 1.13v-.007l-18.88-18.915a8 8 0 0 1-2.34-5.66V85.531c0-21.397-2.226-29.155-6.4-36.977a43.57 43.57 0 0 0-18.105-18.14c-7.719-4.145-15.382-6.368-36.223-6.414h-31.211a1.6 1.6 0 0 1-1.124-2.73l18.88-18.923A7.97 7.97 0 0 1 162.958 0h10.617c28.466 0 38.791 2.972 49.202 8.548M183.602 40c17.635 0 31.929 14.329 31.929 32v20.26a1.6 1.6 0 0 1-2.703 1.152L187.086 68.75a15.9 15.9 0 0 0-5.824-3.719A15.9 15.9 0 0 0 175.616 64h-75.99a1.6 1.6 0 0 1-1.13-2.73l18.908-18.93a7.98 7.98 0 0 1 5.64-2.34z" />
		<path fill="#f4c942" d="m234.219 138.738l18.887 18.922a8.04 8.04 0 0 1 2.34 5.66v10.646c0 28.523-2.966 38.87-8.534 49.302a58.1 58.1 0 0 1-24.135 24.192c-10.41 5.568-20.736 8.54-49.202 8.54h-49.984a1.6 1.6 0 0 1-1.123-2.73v.006l18.88-18.922a7.97 7.97 0 0 1 5.646-2.347h23.104c21.347 0 29.084-2.226 36.892-6.414a43.57 43.57 0 0 0 18.105-18.14c4.174-7.823 6.4-15.581 6.4-36.978v-30.607a1.6 1.6 0 0 1 2.724-1.13M194.31 98.73l18.887 18.944a8.02 8.02 0 0 1 2.333 5.66v60.686c0 17.671-14.294 32-31.93 32h-20.216a1.6 1.6 0 0 1-1.152-2.702v-.007l24.604-25.806a15.9 15.9 0 0 0 3.72-5.831a16 16 0 0 0 1.023-5.654V99.86a1.6 1.6 0 0 1 2.731-1.13" />
		<path fill="#7b8fea" d="m2.724 122.73l18.894 18.923a8.04 8.04 0 0 1 2.34 5.66v23.155c0 21.397 2.218 29.155 6.4 36.977a43.57 43.57 0 0 0 18.097 18.14c7.808 4.19 15.552 6.415 36.9 6.415h30.535a1.6 1.6 0 0 1 1.138 2.73l-18.895 18.923A7.97 7.97 0 0 1 92.494 256H81.87c-28.466 0-38.784-2.972-49.194-8.548A58.1 58.1 0 0 1 8.533 223.26C3.021 212.933.06 202.69.001 174.81L0 123.86a1.6 1.6 0 0 1 2.724-1.13m39.893 39.858h-.007l25.756 24.662a15.9 15.9 0 0 0 5.817 3.719A15.8 15.8 0 0 0 79.83 192h75.99a1.6 1.6 0 0 1 1.123 2.73l-18.901 18.93a8 8 0 0 1-5.64 2.34H71.845a31.964 31.964 0 0 1-31.93-32v-20.26a1.6 1.6 0 0 1 2.703-1.152" />
		<path fill="#d97ee8" d="M92.06 40a1.6 1.6 0 0 1 1.152 2.702L68.601 68.516a15.9 15.9 0 0 0-3.712 5.83A16 16 0 0 0 63.858 80v76.16a1.6 1.6 0 0 1-2.724 1.124L42.247 138.34a8 8 0 0 1-2.332-5.654V72c0-17.671 14.293-32 31.929-32zm39.794-40a1.6 1.6 0 0 1 1.124 2.73l-18.88 18.923A7.98 7.98 0 0 1 108.452 24H85.348c-21.348 0-29.092 2.226-36.9 6.414a43.57 43.57 0 0 0-18.105 18.14c-4.13 7.74-6.353 15.418-6.4 36.307v31.278a1.6 1.6 0 0 1-2.723 1.13L2.347 98.347A8 8 0 0 1 0 92.687V82.04c0-28.522 2.965-38.87 8.533-49.3A58.1 58.1 0 0 1 32.668 8.548C42.975 3.028 53.198.06 81.015 0z" />
	</g>
</svg></div>
            <div class="card"><svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 256 331">
	<defs>
